  ...
  const MENSAGENS = [
    ...
    { icon: "🔓",texto: "Eu amo muito te ouvir, minha princesa. Te ouviria falando sobre qualquer coisa por horas e horas, amor, porque eu amo muito conhecer a vida através da sua perspectiva (eu te acho tão inteligente, meu amorzinho)." },
    ...
    { icon: "🔓", texto: "Amo a forma que você me conhece, meu amorzinho. Eu amo ser sua, minha princesa, no sentido máximo da palavra." },
